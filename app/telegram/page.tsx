          ...
          <div className="max-w-7xl mx-auto">
            <motion.div className="text-center mb-12" variants={itemVariants}>
              ...
              <p className="text-xl text-gray-600 dark:text-gray-300">
                With AdHand you can launch ads on any platform. We support 3 types of advertising in Telegram - focused
              ...
              <motion.div variants={itemVariants} className="space-y-8">
                <div className="space-y-6">
                  <motion.h2
                    ...
                    variants={itemVariants}
                  >
                    AdHand will help you get started quickly
                  </motion.h2>
                </div>
              </motion.div>
        ...
        >
          <div className="max-w-4xl mx-auto text-center">
            <motion.div variants={itemVariants} className="space-y-8">
              ...
              <div className="space-y-4">
                <h2 className="text-3xl md:text-4xl font-bold text-white">Join the AdHand mailing list</h2>
