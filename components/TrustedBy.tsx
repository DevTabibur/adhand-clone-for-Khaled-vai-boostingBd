      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-gray-600 dark:text-gray-400 max-w-2xl mx-auto">
            Join thousands of businesses that trust AdHand to grow their presence across social media platforms
          </p>
        </div>
        ...
        <div className="mt-16 text-center">
          <blockquote className="text-xl md:text-2xl font-medium text-gray-900 dark:text-white italic max-w-4xl mx-auto">
            "AdHand transformed our social media advertising strategy. We've seen a 300% increase in engagement across
            all platforms."
          </blockquote>
